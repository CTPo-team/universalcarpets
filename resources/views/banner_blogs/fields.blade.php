...
<div class="form-group col-sm-12">
    ...
    <a href="{{ route('bannerBlogs.index') }}" class="btn btn-light">Cancel</a>
</div>

@section('scriptsfileinput')
    <script>
        setSingleFile("#single_image_upload","#path_image", <?php echo json_encode(isset($bannerBlog->path_image) ? $bannerBlog->path_image : []); ?>)
    </script>
@endsection