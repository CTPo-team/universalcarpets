...
<div class="form-group col-sm-12">
    ...
    <a href="{{ route('bannerContactus.index') }}" class="btn btn-light">Cancel</a>
</div>

@section('scriptsfileinput')
    <script>
        setSingleFile("#single_image_upload","#path_image", <?php echo json_encode(isset($bannerContactUs->path_image) ? $bannerContactUs->path_image : []); ?>)
    </script>
@endsection