...
<div class="form-group col-sm-12">
    ...
    <a href="{{ route('bannerProducts.index') }}" class="btn btn-light">Cancel</a>
</div>

@section('scriptsfileinput')
    <script>
        setSingleFile("#single_image_upload","#path_image", <?php echo json_encode(isset($bannerProduct->path_image) ? $bannerProduct->path_image : []); ?>)
    </script>
@endsection